...
//    private static Logger logger = LoggerFactory.getLogger(TranslationAPI.class);

    private static final String YOUDAO_URL = "http://openapi.youdao.com/api";

    private static final String APP_KEY = "6543644a29c7b7d3";

    private static final String APP_SECRET = "fv5H0x6bcz2AeJ5CCebHytQEr1TEOWLt";
    ...
    public static String requestForHttp(String url,Map<String,String> params) throws IOException {
        ...
        try{
            ...
            return ((JsonArray)jsonObject.get("translation")).get(0).toString();
        }finally {
            try{
