...
public class duanzao1 extends AbstractCampfireOption {
    private static final UIStrings uiStrings;
    PokeGo pgt= getfirstcanwork_pokego();
    public static final String[] TEXT;
    public int restcount=0;
    public Texture img2=loadImage("images/ui/campfire/smith1.png");
    public duanzao1(boolean active) {
        this.label = TEXT[0];
    ...
    public void useOption() {
        if (this.usable) {
            AbstractDungeon.effectList.add(new duanzao1e());
        }
