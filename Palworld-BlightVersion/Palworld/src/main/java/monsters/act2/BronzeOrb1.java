    ...
    public void takeTurn() {
        switch (this.nextMove) {
            ...
            case 2:
                ...
                {
                    if(m instanceof BronzeAutomaton1)
                    {
                        AbstractDungeon.actionManager.addToBottom(new GainBlockAction(m, m, 12));
                    }
                }

                break;
            case 3:
                AbstractDungeon.actionManager.addToBottom(new ApplyStasisAction1(this));
        }
