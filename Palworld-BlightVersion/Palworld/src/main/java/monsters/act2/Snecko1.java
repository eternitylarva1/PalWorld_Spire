...
public class Snecko1 extends AbstractMonster {
    ...
    public Snecko1(float x, float y) {
    ...
    public void takeTurn() {
        switch (this.nextMove) {
            case 1:
                ...
                AbstractDungeon.actionManager.addToBottom(new AddPowerAction(AbstractDungeon.player, new ConfusionPower(AbstractDungeon.player)));
                break;
            case 2:
