...
public class TheCollector1 extends AbstractMonster {
        ...
        switch (this.nextMove) {
            case 1:
                for(key = 1; key < 3; ++key) {
                    ...
                    AbstractDungeon.actionManager.addToBottom(new SummonMinionAction(newMonster));
                    assignSequentialPosition(newMonster,null);
            ...
            case 3:
                ...
                AbstractPower pp=new StrengthPower(AbstractDungeon.player,this.strAmt);
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player,AbstractDungeon.player,pp));
                ((MonsterGroup) PlayerAddFieldsPatch.f_minions.get(AbstractDungeon.player)).monsters.forEach((monster) -> {
                            ...
                            {
                                AbstractPower p=new StrengthPower(monster,this.strAmt);
                                //尝试修复死后塞牌问题

                                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(monster,monster,p));
                            }
                        }
                );
                break;
            case 4:
                ...
                AbstractDungeon.actionManager.addToBottom(new VFXAction(new CollectorCurseEffect(am.hb.cX, am.hb.cY), 2.0F));
