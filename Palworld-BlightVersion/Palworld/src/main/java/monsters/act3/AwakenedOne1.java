...
public class AwakenedOne1 extends AbstractMonster {
    ...
    public AwakenedOne1(float x, float y) {
        ...
        this.loadAnimation("images/monsters/theForest/awakenedOne1/skeleton.atlas", "images/monsters/theForest/awakenedOne1/skeleton.json", 1.0F);
    ...
    public void takeTurn() {
        ...
        switch (this.nextMove) {
            ...
            case 6:
                ...
                AbstractDungeon.actionManager.addToBottom(new MakeTempCardInDrawPileAction(new Miracle(), 1, true, true));
                break;
            case 8:
        ...
        if (this.form1) {
            ...
            if (num < 25) {
                if (!this.lastMove((byte)2)) {
                    this.setMove(SS_NAME, (byte)2, Intent.ATTACK, 6, 4, true);
                } else {
                    this.setMove((byte)1, Intent.ATTACK, 20);
                }
    ...
    public void damage(DamageInfo info) {
        ...
        if (this.currentHealth <= 0&& !this.halfDead&&!this.hasdone) {
