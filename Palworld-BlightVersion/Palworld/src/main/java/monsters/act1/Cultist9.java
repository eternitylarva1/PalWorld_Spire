...
public class Cultist9 extends AbstractMonster {
    ...
    public Cultist9(float x, float y, boolean talk) {
        ...
        this.loadAnimation("images/monsters/theBottom/cultist9/cultist7.atlas", "images/monsters/theBottom/cultist9/skeleton.json", 1.0F);
        AnimationState.TrackEntry e = this.state.setAnimation(0, "waving", true);
        e.setTime(e.getEndTime() * MathUtils.random());
    }

    public Cultist9(float x, float y) {
        this(x, y, true);
    }
