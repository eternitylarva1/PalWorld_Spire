...
public class Cultist11 extends AbstractMonster {
    ...
    public Cultist11(float x, float y, boolean talk) {
        ...
        this.loadAnimation("images/monsters/theBottom/cultist6/skeleton.atlas", "images/monsters/theBottom/cultist6/skeleton.json", 1.0F);
        AnimationState.TrackEntry e = this.state.setAnimation(0, "waving", true);
        e.setTime(e.getEndTime() * MathUtils.random());
    }

    public Cultist11(float x, float y) {
        this(x, y, true);
    }
