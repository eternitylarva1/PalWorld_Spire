...
public class CultistIronclad extends AbstractMonster {
    ...
    public CultistIronclad(float x, float y, boolean talk) {
        super("铁甲咔咔", "Cultist", 54, -8.0F, 10.0F, 230.0F, 240.0F, (String)null, x, y);
        this.firstMove = true;
        ...
        this.loadAnimation("images/monsters/theBottom/cultist_IRonclad/skeleton.atlas", "images/monsters/theBottom/cultist_IRonclad/skeleton.json", 1.0F);
        AnimationState.TrackEntry e = this.state.setAnimation(0, "waving", true);
        e.setTime(e.getEndTime() * MathUtils.random());
    }

    public CultistIronclad(float x, float y) {
        this(x, y, true);
    }
        ...
        switch (this.nextMove) {
            ...
            case 3:
                ...
                if (AbstractDungeon.ascensionLevel >= 17) {
                    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, new DemonFormPower(this, 5)));
                } else {
                    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, new DemonFormPower(this, 3)));
                }
        ...
        if (this.firstMove) {
            ...
            if(this.hasPower(StrengthPower.POWER_ID)){
                this.addToBot(new AbstractGameAction() {
                    @Override
                    public void update() {
                        int strAmt = CultistIronclad.this.getPower("Strength").amount;
                        this.addToTop(new ApplyPowerAction(CultistIronclad.this, CultistIronclad.this, new StrengthPower(CultistIronclad.this, strAmt), strAmt));
                        CultistIronclad.this.applyPowers();
                        isDone=true;
                    }
                });
            }
