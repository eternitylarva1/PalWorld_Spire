...
public class Cultist15 extends AbstractMonster {
    ...
    public Cultist15(float x, float y, boolean talk) {
        ...
        this.loadAnimation("images/monsters/theBottom/cultist15/skeleton.atlas", "images/monsters/theBottom/cultist15/skeleton37.json", 1.0F);
        AnimationState.TrackEntry e = this.state.setAnimation(0, "waving", true);
        e.setTime(e.getEndTime() * MathUtils.random());
    }

    public Cultist15(float x, float y) {
        this(x, y, true);
    }
        ...
        switch (this.nextMove) {
            ...
            case 3:
                ...
                if (AbstractDungeon.ascensionLevel >= 17) {
                    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, new DemonFormPower(this, 2)));
                } else {
