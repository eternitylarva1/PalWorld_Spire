...
public class DivinityParticleEffect1 extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    ...
    public DivinityParticleEffect1(AbstractMonster m) {
        ...
        this.x = m.hb.cX + MathUtils.random(-m.hb.width / 2.0F - 50.0F * Settings.scale, m.hb.width / 2.0F + 50.0F * Settings.scale);
        this.y = m.hb.cY + MathUtils.random(-m.hb.height / 2.0F + 10.0F * Settings.scale, m.hb.height / 2.0F - 20.0F * Settings.scale);
