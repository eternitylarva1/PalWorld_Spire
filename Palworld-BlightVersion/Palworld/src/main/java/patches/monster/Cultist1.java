...
public class Cultist1 extends AbstractMonster {
    ...
    public Cultist1(float x, float y, boolean talk) {
        ...
        this.img=new Texture("images/monsters/theBottom/bot.png");
        ...
        switch (this.nextMove) {
            case 1:
                ...
                if (MinionHelper.getMinions().monsters.contains(this)) {
                    ...
                    AbstractDungeon.actionManager.addToBottom(new DamageAllEnemiesAction((AbstractCreature) this, retVal, DamageInfo.DamageType.NORMAL, AbstractGameAction.AttackEffect.NONE));
